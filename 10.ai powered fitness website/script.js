...
async function generateApiResponse(aiChatBox){
    ...
    try{
    const response=await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyBjuX4A8vmQPcr8deghsqyJbp5LYq2f-A8",{
      method:"POST",
